...
export default function MealPlansPage() {
    return (
        <main className='pt-20 bg-[#FFFDF5] min-h-screen'>
            <div className='pt-20 pb-10 bg-linear-to-b from-primary/15 via-primary/5 to-[#FFFDF5] text-center relative overflow-hidden'>
                {/* Decorative background circles */}
                <div className='absolute -top-20 -left-20 w-72 h-72 bg-primary/20 rounded-full blur-3xl'></div>
                <div className='absolute -bottom-10 -right-10 w-96 h-96 bg-primary/15 rounded-full blur-3xl'></div>
