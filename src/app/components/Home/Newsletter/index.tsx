        ...
        >
          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-16 items-center'>
            ...
            <div className='lg:col-span-7 relative z-10'>
              ...
              >
                <div className='w-10 h-[2px] bg-[#fed869]' />
              ...
              <div className='relative max-w-lg group'>
                <div className='absolute -inset-1 bg-linear-to-r from-[#fed869] to-[#e6c04f] rounded-full opacity-25 group-focus-within:opacity-50 transition duration-500 blur'></div>
                <div className='relative flex items-center bg-white/10 backdrop-blur-xl border border-white/10 rounded-full p-2 pr-4 focus-within:bg-white transition-all duration-500'>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className='w-12 h-12 bg-linear-to-br from-[#fed869] to-[#e6c04f] rounded-2xl flex items-center justify-center shadow-lg shadow-[#fed869]/30 transition-transform duration-500 group-hover:scale-110'>
            ...
            <div className='lg:col-span-5 relative hidden lg:block'>
              <div className='relative group'>
                ...
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#fed869]/20 rounded-full blur-[60px] animate-pulse pointer-events-none' />
